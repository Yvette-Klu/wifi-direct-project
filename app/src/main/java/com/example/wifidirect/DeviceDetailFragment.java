...
//                        }
        ...
        mContentView.findViewById(R.id.btn_start_document).setOnClickListener(
                new View.OnClickListener(){
                    ...
                    public void onClick(View v) {
                       ...
                       // intent.putExtra(DocumentsContract.EXTRA_INITIAL_URI,fileType);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_DOCUMENT
                && resultCode == WifiDirectActivity.RESULT_OK) {
    ...
    public void onConnectionInfoAvailable(final WifiP2pInfo info) {
        ...
        if (info.groupFormed && info.isGroupOwner) {
            ...
            mContentView.findViewById(R.id.btn_start_document).setVisibility(View.VISIBLE);
            ((TextView) mContentView.findViewById(R.id.status_text)).setText(getResources()
                    .getString(R.string.client_text));
        }
    ...
    public void resetViews() {
        ...
        mContentView.findViewById(R.id.btn_start_document).setVisibility(View.GONE);
        this.getView().setVisibility(View.GONE);
    }
